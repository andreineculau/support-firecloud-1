...
# generated by
# ls $(brew --prefix coreutils)/libexec/gnubin | while read -r VAR; do VAR_UPPER="$(echo "$VAR" | tr "[:lower:]" "[:upper:]")"; echo "$VAR_UPPER = \$(call which,${VAR_UPPER},g$VAR $VAR)"; done # editorconfig-checker-disable-line
